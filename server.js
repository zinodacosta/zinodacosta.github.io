...
function getNextDayTimestamp() {
  ...
  today.setUTCDate(today.getUTCDate() - counter); //Move to the days before this is a bit tricky because the variable increments
...
async function getLastEntry() {
  ...
  try {
    ...
    if (data && data.series) {
      ...
      console.log(
        "This is the latest value of the wholesale price:",
        lastEntry
      );
